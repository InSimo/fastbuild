...
// EmptyAlias
//------------------------------------------------------------------------------
void TestAlias::EmptyAlias() const
{
    FBuildTestOptions options;
    options.m_ConfigFile = "Tools/FBuild/FBuildTest/Data/TestAlias/empty_alias.bff";
    FBuild fBuild( options );
    TEST_ASSERT( fBuild.Initialize() );
}
