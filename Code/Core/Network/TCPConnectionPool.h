...
public:
    ...
    // transmit data
    bool Send( const ConnectionInfo * connection, const void * data, size_t size );
    bool Send( const ConnectionInfo * connection, const void * data, size_t size, const void * payloadData, size_t payloadSize );
